...
export const kursVideos: readonly KursVideo[] = [
  ...
  },
  {
    ...
    titel: "Zeit gegen Geld oder Team",
    unter: "Warum du dein Einkommen nur über andere skalieren kannst",
    kern: "Jeder hat dieselben 24 Stunden, und im Job tauschst du Zeit gegen Geld. Wer ein Team aufbaut, wird für die Leistung anderer mitentlohnt, und das lässt sich fast unbegrenzt ausbauen.",
  ...
  },
  {
    ...
    titel: "Nicht jeder ist, wie er am Anfang wirkt",
    unter: "Woran du erkennst, wer wirklich dabei bleibt",
    kern: "Am Anfang sind alle heiß, wenn sie von 20.000 Euro im ersten Monat hören. Entscheidend ist, wer ernsthaft dabei bleibt, und ob du die Fähigkeit hast, Leute am Ball zu halten.",
  ...
  },
  {
    ...
    titel: "Menschen führen, ohne hinterherzulaufen",
    unter: "Wir sind Geschäftspartner, nicht die Eltern",
    kern: "Zeit zum Ausbilden gibt es, Zeit zum Hinterherrennen nicht. Je größer das Team, desto wichtiger wird Eigeninitiative. Und wer erfolgreich sein will, investiert mindestens so viel Zeit wie vorher im Job.",
